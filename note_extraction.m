...
[song,Fs] = audioread('F:\btech elc\sem5\edsp\project\project resources\sample audio\samplemusic.wav');
figure, plot(song(:,1)), title('new, entire song')
...
audiowrite('F:\btech elc\sem5\edsp\project\project resources\sample audio\samplemusic_recreated.wav',y,Fs);
...
letter
audiowrite('F:\btech elc\sem5\edsp\project\project resources\sample audio\new_wav_recreated.wav',recreate_song,fs);
